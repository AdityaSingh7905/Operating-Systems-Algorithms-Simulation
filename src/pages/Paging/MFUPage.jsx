...
import { MFU } from "../../algo/Paging/MFU";

const MFUPagingSimulator = () => {
  ...
  const startSimulation = () => {
    MFU(referenceString, framesCount, setSnapshots, setPageFaults);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white py-10 px-4 flex flex-col items-center">
      <h1 className="text-3xl font-bold mb-8 text-center">
        MFU Page Replacement Simulator
      </h1>
...
export default MFUPagingSimulator;
