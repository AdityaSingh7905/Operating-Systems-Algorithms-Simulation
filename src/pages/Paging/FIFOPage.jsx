...
import { FIFO } from "../../algo/Paging/FIFO";

const FIFOPagingSimulator = () => {
  ...
  const startSimulation = () => {
    FIFO(referenceString, framesCount, setSnapshots, setPageFaults);
...
export default FIFOPagingSimulator;
